...
declare class TwicBaseComponent implements OnInit, OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TwicBaseComponent, "lib-twic-base", never, { "alt": "alt"; "anchor": "anchor"; "bot": "bot"; "class": "class"; "focus": "focus"; "intrinsic": "intrinsic"; "mode": "mode"; "eager": "eager"; "placeholder": "placeholder"; "position": "position"; "preTransform": "preTransform"; "ratio": "ratio"; "src": "src"; "step": "step"; "transition": "transition"; "transitionDelay": "transitionDelay"; "transitionDuration": "transitionDuration"; "transitionTimingFunction": "transitionTimingFunction"; }, { "stateChangeEvent": "stateChangeEvent"; }, never, never>;
}

declare class TwicImgComponent extends TwicBaseComponent {
    constructor();
    static ɵfac: i0.ɵɵFactoryDeclaration<TwicImgComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TwicImgComponent, "TwicImg", never, {}, {}, never, never>;
}

declare class TwicVideoComponent extends TwicBaseComponent {
    constructor();
    static ɵfac: i0.ɵɵFactoryDeclaration<TwicVideoComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TwicVideoComponent, "TwicVideo", never, {}, {}, never, never>;
}
...
declare class AttributesDirective implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<AttributesDirective, "[twicPicsAttributes]", never, { "twicPicsAttributes": "twicPicsAttributes"; }, {}, never>;
}
