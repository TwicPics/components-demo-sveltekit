...
This project is a demonstration project of [TwicPics Components](https://www.twicpics.com/docs/components/svelte-3?utm_source=github&utm_medium=organic&utm_campaign=components) using [SvelteKit](https://kit.svelte.dev/).
...
Thanks to the open source [TwicPics](https://www.twicpics.com/?utm_source=github&utm_medium=organic&utm_campaign=components) Components, delivering responsive images in your [SvelteKit](https://kit.svelte.dev/) projects has never been easier.
...
All you have to do is set your configuration options to the desired values ([see documentation](https://www.twicpics.com/docs/components/sveltekit?utm_source=github&utm_medium=organic&utm_campaign=components#setup-options)).
